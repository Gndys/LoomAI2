...
// 2. env.example contains placeholder values which are sufficient for Next.js build prep
// 3. Build-time steps only need type generation, not actual database connection
